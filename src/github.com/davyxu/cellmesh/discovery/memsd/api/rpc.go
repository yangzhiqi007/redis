...
func (self *memDiscovery) remoteCall(req interface{}, callback interface{}) error {
	...
	return remoteCallEx(self.Session(), req, callback, self.config.RequestTimeout)
}

// callback =func(ack *YouMsgACK)
func remoteCallEx(ses cellnet.Session, req interface{}, callback interface{}, timeout time.Duration) error {
